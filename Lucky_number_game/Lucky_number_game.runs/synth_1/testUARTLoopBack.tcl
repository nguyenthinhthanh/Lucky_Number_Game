...
namespace eval ::optrace {
  variable script "D:/Vivado/Git_Lucky_number_game/Lucky_number_game/Lucky_number_game.runs/synth_1/testUARTLoopBack.tcl"
...
synth_design -top testUARTLoopBack -part xc7z020clg400-1
...
write_checkpoint -force -noxdef testUARTLoopBack.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file testUARTLoopBack_utilization_synth.rpt -pb testUARTLoopBack_utilization_synth.pb"
