...
namespace eval ::optrace {
  variable script "D:/Vivado/Git_Lucky_number_game/Lucky_number_game/Lucky_number_game.runs/synth_1/controlGameWithBluetooth.tcl"
...
read_verilog -library xil_defaultlib {
  ...
  D:/Vivado/Git_Lucky_number_game/Lucky_number_game/Lucky_number_game.srcs/sources_1/new/controlGameWithBluetooth.v
}
...
synth_design -top controlGameWithBluetooth -part xc7z020clg400-1
...
write_checkpoint -force -noxdef controlGameWithBluetooth.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file controlGameWithBluetooth_utilization_synth.rpt -pb controlGameWithBluetooth_utilization_synth.pb"
